...
- **D. Internal linking audit** — Do all 40 blog posts link to product/area pages? Do hub/product pages cross-link to best-fit blogs? Vitrums-style bidirectional linking lifts topical authority.
...
- `/sr3-residential-steel-door` — LPS 1175 SR3 (Enhanced upgrade tier) explained
...
## Blog Posts (40 posts, all published)
- 40 posts in `src/data/blog/posts/*.ts`, all live, zero staged
...
- **Google Business Profile:** verified as "SteelR - Bespoke Steel Entrance Doors", nationwide UK. **Address VISIBLE — intentional** (11 Silver Birch Cl, Ickenham, UB10 8AP shows publicly with a precise pin; verified live 24 Jun 2026 via anonymous Maps scrape). Kept visible to prioritise early local-pack visibility on a young listing (2 reviews). Trade accepted by owner: home address public + sits against Google's SAB guideline, vs the visibility lift + avoiding a switch-time re-verification dip. **Revisit → hide (convert to service-area business) once the profile matures (~10+ reviews).** GBP IDs: CID `11037666943331735601`, Place ID `ChIJFR9Vn5ptdkgRMRhc2pqrLZk`. See `memory/feedback_address-hidden-affects-visibility.md`.
...
- **Bespoke Steel Entrance Doors:** "UK-manufactured bespoke steel front doors, made to measure with no standard sizes. PAS 24:2022 certified, BS EN 1627:2011 RC4 single leaf, unglazed as Standard, LPS 1175 SR3 (Enhanced upgrade) and SR4 D10 Issue 8 (Commercial-grade upgrade) available, LPS 1673 Ultra-high tier by enquiry. Secured by Design approved, FD30S fire rated. Nationwide installation by our own team." (Original draft said "made to measure for a single property" which user flagged as ambiguous; rewrote with "no standard sizes". Updated 5 May 2026 to align with the four-tier ladder rolled out site-wide on 18 Apr — earlier draft incorrectly said "BS EN 1627 Class 3".)
- **PAS 24 Certified Security Doors:** "PAS 24:2022 certified steel front doors meeting Approved Document Q for new-build dwellings. Every SteelR door exceeds PAS 24 with BS EN 1627:2011 RC4 single leaf, unglazed certification as Standard. LPS 1175 SR3 (Enhanced upgrade) and SR4 (Commercial-grade upgrade) available on every door. Suitable for new builds, flats, HMOs and replacement doors."
