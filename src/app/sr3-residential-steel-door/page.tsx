          ...
          links: [
            {
              ...
              description: "Side-by-side comparison of LPS 1175 SR3 and SR4 on a UK residential front door. Tool catalogue, attack duration, when each tier applies, and how the four-tier ladder stacks.",
            },
            {
