    ...
    <>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                quote: "We looked at several door companies but SteelR were the only ones offering genuine SR3/SR4 security with this level of design. The finished door exceeded every expectation.",
                name: "David T.",
                location: "Cheshire",
              },
              {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
          <ScrollReveal direction="left">
            <div>
              ...
              >
                Every Steelr door is manufactured to SR3 high-security standards as the baseline, with SR4 (LPS 1175 Issue 8) available as an upgrade — a commercial-grade security level rarely offered on residential front doors in the United Kingdom. We work with homeowners, architects and developers who understand that the entrance to a home should be both beautiful and impenetrable.
              </p>
              <p
                style={{
                  fontFamily: "var(--font-body), Montserrat, sans-serif",
      ...
      <section className="bg-cream ribbon-bg py-20 md:py-32 px-6 md:px-16">
        <div className="max-w-3xl mx-auto">
          ...
          {[
            { q: "What security rating do your steel front doors have?", a: "Every SteelR residential steel front door is tested to SR3 as standard under European standard BS EN 1627:2011 (Class 3). For homeowners who want the highest level of physical security, we also offer SR4 (LPS 1175 Issue 8, Security Rating 4) — a commercial-grade certification rarely offered on doors built for the home. During SR4 testing, the door must withstand sustained forced attack using a wider range of heavy-duty tools — including crowbars, drills, angle grinders and battery-operated cutting tools — for a longer period than SR3. Both far exceed the PAS 24 standard required by Approved Document Q for new-build dwellings. Every SteelR door is Secured by Design approved — the UK police-preferred specification for crime prevention." },
            ...
            { q: "Are your doors fire rated?", a: "Yes. All SteelR doors carry FD30S certification (30 minutes fire and smoke resistance) as standard, with FD60 (60-minute) available on request. This satisfies Approved Document B, the Fire Safety Act 2021 and the Building Safety Act 2022. Combined with PAS 24 certification and our SR3/SR4 security ratings, every SteelR door meets both the fire safety and security requirements for new builds, flats, HMOs and housing association properties — whether you need a fire rated steel front door for your home or a commercial specification." },
          ].map((faq, i) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        "mainEntity": [
          {"@type": "Question", "name": "What security rating do your steel front doors have?", "acceptedAnswer": {"@type": "Answer", "text": "Every SteelR residential steel front door is tested to SR3 as standard under European standard BS EN 1627:2011 (Class 3). For homeowners who want the highest level of physical security, we also offer SR4 (LPS 1175 Issue 8, Security Rating 4) — a commercial-grade certification rarely offered on doors built for the home. During SR4 testing, the door must withstand sustained forced attack using a wider range of heavy-duty tools — including crowbars, drills, angle grinders and battery-operated cutting tools — for a longer period than SR3. Both far exceed the PAS 24 standard required by Approved Document Q for new-build dwellings. Every SteelR door is Secured by Design approved — the UK police-preferred specification for crime prevention."}},
