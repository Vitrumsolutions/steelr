    ...
    <>
      ...
      <section className="bg-cream ribbon-bg py-20 md:py-32 px-6 md:px-16">
        <div className="max-w-3xl mx-auto">
          ...
          {[
            { q: "What is an SR3 security rating?", a: "SR3 is the highest level of physical security testing for entrance doors under European standard BS EN 1627:2011 (Class 3). During testing, the door must withstand sustained forced attack using heavy-duty tools — including crowbars, drills and angle grinders — for an extended period without the attacker gaining entry. SR3 far exceeds the PAS 24 standard required by Approved Document Q for new-build dwellings. Every SteelR door achieves SR3 as standard and is Secured by Design approved — the UK police-preferred specification for crime prevention." },
