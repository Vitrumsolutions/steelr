...
const processSteps = [
  ...
  },
  {
    num: "04",
    title: "Installation",
    desc: "Professional installation by our team. Typically around 8 weeks from enquiry to completion.",
  },
];
    ...
    <>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                quote: "We looked at several door companies but SteelR were the only ones offering genuine BS EN 1627 RC4 security with this level of design. The finished door exceeded every expectation.",
                name: "David T.",
                location: "Cheshire",
              },
              {
      ...
      <section style={{ background: "#ede8df" }} className="ribbon-bg py-12 md:py-16 px-6 md:px-16">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 text-center md:text-left">
          {[
            ...
            { num: "RC4", label: "BS EN 1627:2011", sub: "Single leaf, unglazed" },
      ...
      <section className="bg-cream ribbon-bg py-20 md:py-32 px-6 md:px-16">
        <div className="max-w-3xl mx-auto">
          ...
          {[
            ...
            { q: "How long does the process take?", a: "From initial enquiry to completed installation, the typical lead time is approximately 8 weeks. This includes a site survey within 1 to 2 weeks of enquiry, a design approval stage where you confirm colour, hardware and glazing, followed by around 6 weeks of manufacturing in our UK facility. Installation itself is usually completed in a single day. More complex specifications or multi-door projects may require additional time, and your specific timeline is confirmed during the order process." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "mainEntity": [
          ...
          {"@type": "Question", "name": "How long does the process take?", "acceptedAnswer": {"@type": "Answer", "text": "From initial enquiry to completed installation, the typical lead time is approximately 8 weeks. This includes a site survey within 1 to 2 weeks of enquiry, a design approval stage where you confirm colour, hardware and glazing, followed by around 6 weeks of manufacturing in our UK facility. Installation itself is usually completed in a single day. More complex specifications or multi-door projects may require additional time, and your specific timeline is confirmed during the order process."}},
