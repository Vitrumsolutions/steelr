...
export function CredentialsStrip() {
  return (
    <section className="bg-site-black py-7 px-6 md:px-16" aria-label="Certifications">
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-3 md:gap-x-8 mx-auto">
