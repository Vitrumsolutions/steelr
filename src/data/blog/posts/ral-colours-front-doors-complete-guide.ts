...
const post: BlogPost = {
  ...
  readTime: "8 min read",
  category: "Design",
  image: "/images/gallery/steelr-sage-panelled-arched-wreath.jpg",
  imageAlt:
    "Sage green panelled steel entrance door with arched fanlight and wreath — RAL colour finish",
  content: `## The Language of Door Colour
...
RAL Design colours are available from specialist coaters but may carry longer lead times and a premium cost, as they are typically mixed to order rather than held in stock. For clients seeking an exact shade that falls between RAL Classic options, RAL Design provides the solution. Explore our full [colour options](/colours) to see what is available.
...
Black doors are the default choice in [Notting Hill](/areas/notting-hill) and across central London, where they complement white stucco, London stock brick and Portland stone facades with equal authority.
...
**The Cotswolds and Home Counties** — Dark green, olive and muted earth tones. The warm honey tones of Cotswold stone call for colours with depth and warmth. RAL 6014 (yellow olive) and RAL 7006 (beige grey) are regional favourites, particularly in villages around [Marlow](/areas/marlow) and the Chilterns.
...
Dual-colour specification is a standard option on SteelR doors, finished with the same polyester powder coat process on both faces. Browse [our collection](/collection) to see how different colour combinations present in completed installations.
...
1. **Surface preparation** — the steel is shot-blasted or chemically pre-treated to create a clean, profiled surface
2. **Powder application** — electrostatically charged powder particles are sprayed onto the grounded steel surface, where they adhere evenly
3. **Curing** — the coated door enters a curing oven at approximately 200C, where the powder melts, flows and cross-links into a continuous, hard film
