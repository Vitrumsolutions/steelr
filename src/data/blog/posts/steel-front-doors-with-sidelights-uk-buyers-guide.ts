...
const post: BlogPost = {
  slug: "steel-front-doors-with-sidelights-uk-buyers-guide",
  title: "Steel Front Doors with Sidelights: UK Buyer's Guide",
  description:
    "How to specify a steel front door with sidelights for a UK home. Configurations, glazing, security ratings as one assembly, and what affects lead time.",
  date: "2026-04-28",
  readTime: "8 min read",
  category: "Buying Guide",
  image: "/images/gallery/steelr-taupe-panelled-chrome-dual-sidelights.jpg",
  imageAlt:
    "Taupe panelled SteelR steel front door with chrome hardware and dual sidelights on a UK home",
  content: `## Why Sidelights Change a Front Door
...
If you have not yet read it, the [bespoke steel front doors UK hub](/bespoke-steel-front-doors-uk) covers the complete SteelR specification. The [collection of doors with sidelights](/collection/sidelights) shows representative configurations from recent installations.
...
For a detailed walkthrough of what each certification means, see the [PAS 24 hub page](/pas-24-steel-entrance-door), the [SR3 residential standard](/sr3-residential-steel-door) and the [Secured by Design approval](/secured-by-design-steel-front-door).
