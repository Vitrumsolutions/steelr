...
**Grand architectural proportions.** Georgian townhouses in [London](/areas/london), substantial detached homes in [Buckinghamshire](/areas/buckinghamshire) and country houses in [Surrey](/areas/surrey) often have entrance porticos, columns or canopies designed to frame a double door. In these settings, a single door looks undersized.
...
For properties in [Buckinghamshire](/areas/buckinghamshire) and [Surrey](/areas/surrey) where substantial homes regularly require delivery of oversized furnishings, the practical access advantage of double doors is frequently cited as a deciding factor.
...
In many cases, yes — but the opening must be widened, which involves structural work including a new lintel. We recommend a structural survey before committing to this approach. For some properties, a single door with sidelights achieves a similar visual width without structural modification. For a wider view of how bespoke configurations are specified, see our [bespoke steel front doors UK](/bespoke-steel-front-doors-uk) overview.`,
};
