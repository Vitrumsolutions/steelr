...
const post: BlogPost = {
  ...
  readTime: "8 min read",
  category: "Guides",
  image: "/images/gallery/steelr-navy-panelled-lanterns-fanlight.jpg",
  imageAlt:
    "Navy panelled steel entrance door with lanterns and fanlight — spring home improvement front door upgrade",
  content: `## Why Spring Is the Right Time to Upgrade Your Front Door
...
Even if you are not selling, spring viewings from neighbours and passers-by mean your upgrade will be noticed. For properties in desirable areas across [London](/areas/london), [Surrey](/areas/surrey) and [Hampshire](/areas/hampshire), where street-level presentation carries significant social weight, this visibility matters.
...
For properties across [London](/areas/london) and [Surrey](/areas/surrey), where competition among premium homes is intense, the difference between a standard composite door and a bespoke steel entrance door can be the difference between a property that lingers on the market and one that attracts immediate interest.
...
For more detail on each stage, see [our process](/process).
...
**Can I see examples before I commit?** Yes. Browse [our collection](/collection) for examples of completed installations across a range of styles, colours and property types. You can also request images specific to your property type during the design discussion.
