...
Polished brass is the finish of choice across much of [Chiswick](/areas/chiswick), where Victorian and Edwardian terraces benefit from its warmth and historical authenticity.
...
The finish itself requires careful specification. Powder-coated matt black is durable and repairable. Painted finishes are less resilient. PVD matt black is the premium option, offering superior scratch resistance and colour stability. Properties across [Wimbledon](/areas/wimbledon) frequently specify matt black hardware for its understated, modern character.
...
The relationship between door colour and hardware finish is the single most important consideration in achieving a cohesive entrance. The full [colour options](/colours) available for bespoke steel doors span the entire RAL range, so the hardware pairing possibilities are extensive.
