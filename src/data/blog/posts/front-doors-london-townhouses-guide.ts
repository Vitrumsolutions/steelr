...
Victorian doors suit a wider range of colours than Georgian examples. Heritage paint ranges from the period include dark red, ochre, deep teal, chocolate brown and the rich blue-blacks that remain popular today. The full RAL range of [colour options](/colours) means every shade can be precisely reproduced.
