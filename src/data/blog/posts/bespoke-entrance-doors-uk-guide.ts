...
const post: BlogPost = {
  ...
  image: "/images/gallery/steelr-champagne-arched-geometric-double.jpg",
  imageAlt:
    "Champagne arched geometric double steel entrance doors, bespoke entrance door design",
  content: `## What Does Bespoke Actually Mean?
...
Victorian, Edwardian and Georgian properties were built to no standardised dimensions. Doorways in a [Chelsea](/areas/chelsea) townhouse or a [Kensington](/areas/kensington) villa may be wider, taller or differently proportioned to anything available off the shelf. Arched openings, fanlights and deep reveals add further complexity.
...
Understanding [our process](/process) helps set expectations for timeline, involvement and cost. A bespoke entrance door is not an impulse purchase, it is a considered investment that follows a structured path from first conversation to final installation.
...
To begin the process, you can [request a consultation](/contact) at any stage, even if your plans are still forming.
...
For properties in premium locations, [Chelsea](/areas/chelsea), [Kensington](/areas/kensington), [Beaconsfield](/areas/beaconsfield) and comparable areas, the entrance door sets the tone for the entire property. It communicates quality, attention to detail and a refusal to compromise. These are the qualities that high-end buyers are looking for.
