...
See our [heritage steel front doors hub](/heritage-steel-front-doors-uk) for a complete guide to specifying a steel front door in a listed or conservation-area home, covering Listed Building Consent process, Article 4 directions, period-correct ironmongery and RAL palette.
...
For the majority of London period homes, SR3 is the right specification. SR4 is worth considering on detached villas in leafier suburbs, on homes where the client holds significant moveable value on site, and on properties where the owner has experienced an attempted break-in. An [SR4 upgrade](/blog/sr4-lps-1175-commercial-grade-residential) is available on any SteelR specification and is typically specified on a minority of our London projects.`,
};
