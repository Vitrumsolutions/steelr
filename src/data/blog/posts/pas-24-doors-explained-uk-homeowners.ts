...
const post: BlogPost = {
  ...
  readTime: "8 min read",
  category: "Security",
  image: "/images/gallery/steelr-black-ornate-medallion-driveway.jpeg",
  imageAlt:
    "Black ornate steel entrance door with medallion detail on a private driveway — PAS 24 certified security door",
  content: `## What Is PAS 24?
...
The standard was first published in 1999 and has been updated several times since, with the most recent revision in 2022. It applies to all external doorsets including front doors, back doors, French doors and sliding patio doors. For homeowners navigating the world of [security standards](/security), PAS 24 is often the first certification they encounter — but it is far from the last word in entrance door security.
...
The requirement does not automatically apply to replacement doors in existing dwellings, though your local authority may impose conditions — particularly in [areas across London](/areas/london) and the Home Counties where burglary rates are above the national average.
...
A door that passes PAS 24 testing may offer no meaningful resistance to a burglar equipped with a large crowbar or battery-powered angle grinder. An [SR3-rated door](/security-specification) is independently proven to withstand exactly that scenario.
...
- **Properties in [Surrey](/areas/surrey) and [Buckinghamshire](/areas/buckinghamshire)** conservation areas where design takes precedence over standardised specifications
...
For homeowners who take security seriously — particularly those with properties in affluent areas across [London](/areas/london), [Surrey](/areas/surrey) and [Buckinghamshire](/areas/buckinghamshire) — the gap between PAS 24 and SR3 is significant.
...
For a detailed comparison of testing methods and certification levels, see our complete [security specification](/security-specification) page.
