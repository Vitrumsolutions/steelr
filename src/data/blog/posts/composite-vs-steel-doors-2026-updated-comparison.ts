...
const post: BlogPost = {
  ...
  image: "/images/gallery/steelr-teal-panelled-glass-hallway.jpg",
  imageAlt:
    "Teal panelled steel entrance door with glass hallway — composite vs steel doors 2026 comparison",
  content: `## The Composite vs Steel Doors Debate in 2026
...
### Steel Doors
- U-values of **0.87-1.0 W/m2K** with polyurethane-injected cores and thermal break technology
- Consistent performance over time as the core material does not degrade
- No thermal bridging when properly designed with full perimeter thermal breaks

### Composite Doors
- U-values of **1.0-1.4 W/m2K** for premium products
- Performance can diminish over time as core materials age
- Budget products may achieve only 1.6-1.8 W/m2K
...
For homeowners across [London](/areas/london), [Surrey](/areas/surrey) and [Buckinghamshire](/areas/buckinghamshire), where architectural distinction is valued, these capabilities represent a design vocabulary that composite simply cannot match.
