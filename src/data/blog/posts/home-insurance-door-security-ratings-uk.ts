...
const post: BlogPost = {
  ...
  readTime: "7 min read",
  category: "Security",
  image: "/images/gallery/steelr-black-traditional-double-columns.jpg",
  imageAlt:
    "Black traditional steel double entrance doors with columns — home insurance door security ratings UK",
  content: `## The Link Between Your Front Door and Your Insurance
...
Visit our [security overview](/security) for a complete explanation of the certifications our doors carry.
...
1. Contact your insurer or broker and describe the upgrade
2. Provide the documentation listed above
3. Ask whether the upgrade changes your premium, excess or policy terms
4. Obtain written confirmation of any changes
5. Update your home inventory and insurance schedule accordingly
