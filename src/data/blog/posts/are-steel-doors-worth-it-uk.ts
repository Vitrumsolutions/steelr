...
- **Composite doors** (GRP over foam core): Typical lifespan 10 to 20 years. The GRP skin can fade, crack or delaminate with prolonged UV exposure. The foam core can absorb moisture if the skin is compromised, leading to structural weakness and poor insulation
...
For properties in higher-risk areas, or simply for homeowners who value genuine security over minimum compliance, the difference between SR3 and PAS 24 is substantial. You can read the full technical comparison on our [security specification page](/security-specification).
...
A well-specified steel door achieves U-values of **1.0 to 1.8 W/m²K**, which is comparable to or better than:

- Double-glazed windows (typical U-value 1.2 to 1.6 W/m²K)
- Timber doors (typical U-value 1.4 to 2.0 W/m²K)
- Composite doors (typical U-value 1.0 to 1.6 W/m²K)
- The surrounding wall construction in many period properties (solid brick walls: 1.5 to 2.0 W/m²K)
...
In prime property markets, [Kensington](/areas/kensington), [Chelsea](/areas/chelsea), [Virginia Water](/areas/virginia-water), [Beaconsfield](/areas/beaconsfield), a cheap front door on an expensive house is immediately noticeable. It signals compromise, and buyers of premium properties do not want compromise.

### The Numbers

Research from the Federation of Master Builders and various estate agency surveys suggests a new front door can return **50 to 75% of its cost** in added property value, with premium doors in prime locations potentially exceeding 100% ROI. The return is highest where the existing door is visibly deteriorated, replacing a peeling, warped timber door or a faded composite with a crisp, perfectly finished steel door transforms the entire facade.
...
The [RAL colour system](/colours) offers over 200 standard colours, and we can match to any reference including Farrow & Ball, Little Greene, and conservation-specified heritage palettes. **Dual-colour finishing** means you can have a heritage-appropriate colour on the exterior and a completely different colour on the interior, a significant advantage for conservation area properties.

### Style Range

Browse our [collection](/collection) to see the range of styles available:
...
1. **Chemical pre-treatment**, phosphate conversion coating for adhesion and corrosion resistance
2. **Zinc primer**, additional corrosion barrier on all surfaces
3. **Powder-coat top coat**, electrostatically applied and oven-cured at approximately 200°C
...
Yes, steel doors are heavier than composite or uPVC alternatives, typically 60 to 100kg for a single leaf depending on specification. However, this is managed through:
...
Steel can dent if struck with significant force by a hard object. However, the steel gauges used in entrance doors, typically 1.2 to 2.0mm, are substantially more resistant to impact than the GRP skins on composite doors (which can crack, chip or puncture) or the thin aluminium skins on some premium alternatives.
...
- **Temporary situations**, if you are planning to sell within 1 to 2 years, the ROI calculation changes. A good composite door at half the price might be the pragmatic choice
