...
const post: BlogPost = {
  ...
  imageAlt:
    "Olive green traditional steel entrance door with arched stone surround — conservation area compliant design",
...
There are over **10,000 conservation areas** in England alone, covering medieval town centres, Georgian terraces, Victorian suburbs, Arts and Crafts villages, garden cities and post-war estates of architectural merit. Notable concentrations exist in [Richmond](/areas/richmond), [Bath](/areas/bath), [Oxford](/areas/oxford) and across London's inner boroughs.
