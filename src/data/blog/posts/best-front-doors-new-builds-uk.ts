...
const post: BlogPost = {
  ...
  content: `## Getting Front Door Specification Right From the Start
...
For developers building houses, Part B requirements for the entrance door are less onerous, but any dwelling with an integral garage requires an FD30 self-closing door between the garage and the habitable space. For comprehensive guidance on fire ratings, see our guide to [fire rated doors](/fire-rated-doors).
...
Browse [our collection](/collection) to see the range of styles and configurations available for development specification.
