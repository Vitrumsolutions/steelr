...
const post: BlogPost = {
  ...
  readTime: "8 min read",
  category: "Technical",
  image: "/images/gallery/steelr-grey-panelled-stone-surround.jpg",
  imageAlt:
    "Grey panelled steel entrance door with stone surround, specifying steel doors for architects",
  content: `## Why Steel Door Specification Demands Precision
...
Beyond PAS 24, the Loss Prevention Certification Board's LPS 1175 standard provides graded security ratings. **SR3 is the LPCB police-preferred residential tier**, resisting sustained attack with professional tools over an extended period. For high-value residential projects across [London](/areas/london), [Manchester](/areas/manchester) and [Birmingham](/areas/birmingham), SR3 is increasingly the default specification rather than an enhancement. SteelR ships BS EN 1627 RC4 as Standard, with LPS 1175 SR3 Enhanced upgrade, SR4 D10 Issue 8 Commercial-grade upgrade and LPS 1673 attack-resistance Ultra-high (by enquiry) available on every door, allowing architects to specify a single supplier across residential, high-risk residential and commercial-grade projects.
...
- **RAL colour**, any colour from the full RAL Classic range. The full [colour options](/colours) available allow precise matching to the architect's intent
...
1. **Initial consultation**, share design intent, performance requirements and project programme with the manufacturer
2. **Scheme design drawings**, the manufacturer produces preliminary drawings showing doorset configuration, hardware positions and finish options
3. **Colour and finish samples**, physical RAL colour panels and hardware finish samples for approval. Always approve colour from a physical sample, never from a screen
4. **Technical submission**, full specification, test certificates, structural fixing details, threshold detail, hardware schedule
