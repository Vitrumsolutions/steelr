...
const post: BlogPost = {
  ...
  image: "/images/gallery/steelr-sage-traditional-arched-brick.jpg",
  imageAlt:
    "Sage green steel entrance door with traditional arched design set in brick surround, steel door for Kent property",
  content: `## Kent's Architectural Heritage
...
This diversity makes Kent a particularly interesting context for entrance door specification. A door that is perfect for a Victorian townhouse in [Sevenoaks](/areas/sevenoaks) may be entirely wrong for an oast house conversion in the Weald or a Georgian terrace in [Tunbridge Wells](/areas/tunbridge-wells). Understanding Kent's architecture is essential to specifying a door that belongs.
...
The Georgian legacy is strong across Kent's principal towns. [Tunbridge Wells](/areas/tunbridge-wells), Rochester, Canterbury and parts of [Sevenoaks](/areas/sevenoaks) contain substantial Georgian terraces and detached villas characterised by symmetrical facades, tall sash windows and formal entrance arrangements. The **six-panel door with a fanlight above** is the archetypal Georgian entrance, often painted in historically appropriate colours.
...
Browse the full range in [our collection](/collection) to find the design direction that suits your Kent property.
...
Properties in the Kent countryside, particularly those in the Weald, the Downs and the rural areas around [Tonbridge](/areas/tonbridge) and Cranbrook, share the security challenges common to isolated rural homes. Set-back properties with limited natural surveillance are attractive targets for burglars who value time and privacy to work on a door.
...
The affluent commuter towns of north-west Kent, [Sevenoaks](/areas/sevenoaks), [Tunbridge Wells](/areas/tunbridge-wells), [Tonbridge](/areas/tonbridge), contain high-value properties that are known targets for organised burglary gangs. Kent Police crime prevention advice consistently emphasises the importance of physical security for external doors and windows.
...
- [Tonbridge](/areas/tonbridge), residential properties across the town and surrounding Wealden countryside
...
From initial consultation to completed installation, the typical timeline is approximately eight weeks. This includes site survey, design development, bespoke manufacture and finishing. The installation itself is completed within a single day, with your property fully secured before the team leaves site.
