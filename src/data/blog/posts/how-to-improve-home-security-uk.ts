...
If you could make only one security improvement to your home, **upgrade your front door**. A certified steel front door (BS EN 1627 RC4 Standard with the LPS 1175 SR3 Enhanced upgrade and Secured by Design accreditation) eliminates the most common entry method and sends a clear signal that your property is well protected. Homeowners across [London](/areas/london), [Surrey](/areas/surrey) and [Buckinghamshire](/areas/buckinghamshire) increasingly specify this combination. SteelR ships BS EN 1627 RC4 with Secured by Design as Standard, with the LPS 1175 SR3 Enhanced upgrade and SR4 Commercial-grade upgrade available where the threat profile demands it.

At SteelR, every entrance door we manufacture is **BS EN 1627 RC4 certified as Standard** (with **LPS 1175 SR3 Enhanced upgrade** available), **Secured by Design accredited** and built with **multi-point locking systems** and **security-rated glazing** as standard. Combined with ISO 9001 certified manufacturing and professional installation, a SteelR door provides the strongest possible foundation for your home security. For the police-preferred specification standard explained in detail, see our [Secured by Design steel front door](/secured-by-design-steel-front-door) overview. Contact us to discuss how we can help secure your home.
