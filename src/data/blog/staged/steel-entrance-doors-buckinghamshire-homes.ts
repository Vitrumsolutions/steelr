...
const post: BlogPost = {
  ...
  title: "Steel Entrance Doors for Buckinghamshire Homes: Local Guide",
  description:
    "Local guide to steel entrance doors for Buckinghamshire homes — covering Chilterns AONB, conservation areas, popular styles and installation across Bucks.",
  date: "2026-06-11",
  readTime: "8 min read",
  category: "Location Guides",
  image: "/images/gallery/steelr-olive-panelled-ring-knocker-sidelight.jpg",
  imageAlt:
    "Olive green steel entrance door with ring knocker and sidelight — bespoke steel door for Buckinghamshire home",
  content: `## Buckinghamshire's Distinctive Property Landscape
...
Browse the full range of designs available for Buckinghamshire properties in [our collection](/collection).
...
- [Beaconsfield](/areas/beaconsfield) — period and executive homes in the Old Town and surrounding areas
- [Gerrards Cross](/areas/gerrards-cross) — high-value residential properties with demanding security requirements
- [Amersham](/areas/amersham) — Old Town conservation properties and Amersham-on-the-Hill residential
