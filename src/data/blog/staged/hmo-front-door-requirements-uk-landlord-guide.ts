...
const post: BlogPost = {
  slug: "hmo-front-door-requirements-uk-landlord-guide",
  title: "HMO Front Door Requirements UK: Landlord and Developer Guide",
  description:
    "What UK landlords and developers need on HMO front doors. FD30S fire rating, PAS 24 security, communal vs flat entrance rules, and post-Grenfell enforcement.",
  date: "2026-04-30",
  readTime: "9 min read",
  category: "Security",
  ...
  content: `## Why HMO Door Specification Has Tightened
...
For the underlying fire regulations, see the [fire-rated FD30 hub page](/fire-rated-fd30-front-door) and the [fire rated front doors UK regulations guide](/blog/fire-rated-front-doors-uk-regulations-guide). For the security baseline, see the [PAS 24 explainer for UK homeowners](/blog/pas-24-doors-explained-uk-homeowners).
...
- **PAS 24:2022 certified** for security performance under Approved Document Q (mandatory on new builds and conversions, recommended on replacements)
- **Secured by Design approval** is increasingly requested by insurers for HMO buildings
- **SR3 or higher** under BS EN 1627 is the appropriate baseline for security where the building houses vulnerable occupants or sits in a higher-risk area
- Access control: multipoint locking, tamper-resistant cylinder, and where applicable an audio or video entry system
...
Specification minimum:
- **FD30S rated** under BS 476-22 or BS EN 1634-1, providing thirty minutes of fire integrity plus cold smoke seal performance. The S suffix is non-negotiable. Cold smoke is a leading cause of fatality in dwelling fires.
- **PAS 24:2022 certified** for security on flats where the door is also the dwelling's primary entrance
- **Self-closing** with a certified door closer that meets EN 1154 and is configured to fully close from any open position
- **Intumescent strips and cold smoke seals** correctly fitted in the frame rebate
- **Three hinges minimum**, fire-rated, with appropriate intumescent washers
...
Start with a [free site survey](/contact) for any HMO door programme. Coverage is nationwide UK mainland with no regional surcharge. The [fire rated FD30 hub page](/fire-rated-fd30-front-door) and the [secured by design steel front door page](/secured-by-design-steel-front-door) cover the underlying certifications in detail.`,
};
