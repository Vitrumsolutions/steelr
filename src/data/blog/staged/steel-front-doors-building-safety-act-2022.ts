...
const post: BlogPost = {
  slug: "steel-front-doors-building-safety-act-2022",
  title: "Steel Front Doors and the Building Safety Act 2022",
  description:
    "What the Building Safety Act 2022 means for steel front door specification on UK higher-risk buildings. Accountable Person duties, golden thread, FD30 vs FD60.",
  date: "2026-05-03",
  readTime: "10 min read",
  category: "Security",
  image: "/images/detail/steelr-black-detail-hinge-locking-pin.jpg",
  imageAlt:
    "Engineered hinge and locking pin detail on a SteelR steel front door, illustrating the golden-thread documentary chain under the Building Safety Act 2022",
  content: `## A Door is Now a Documentary Object
...
For the underlying door specifications referenced throughout, see the [PAS 24 hub page](/pas-24-steel-entrance-door), the [SR3 residential standard](/sr3-residential-steel-door), the [Secured by Design approval page](/secured-by-design-steel-front-door) and the [fire rated FD30 hub](/fire-rated-fd30-front-door).
...
For a detailed walkthrough of the fire ratings, see the [fire rated front doors UK regulations guide](/blog/fire-rated-front-doors-uk-regulations-guide). For HMO-specific specification, see the [HMO front door requirements landlord guide](/blog/hmo-front-door-requirements-uk-landlord-guide).
...
1. **PAS 24:2022 certificate** for the specific door specification, issued by a UKAS-accredited test laboratory
2. **Fire test report** under BS 476-22 or BS EN 1634-1, identifying the precise leaf, frame, glazing, hinge and seal specification tested. The certificate must reference the configuration installed.
3. **Secured by Design certificate** where applicable, granted against the complete door assembly
4. **BS EN 1627 test report** where the door is rated SR3 or higher
5. **Installation drawings** showing fixing centres, frame substrate requirements, intumescent installation, and any specific structural notes
6. **Self-closer specification** with EN 1154 compliance and adjustment instructions
7. **Hardware schedule** including cylinder specification, multipoint lock, hinges, letter plate, viewer
8. **Manufacturer's identity and warranty terms** in writing
9. **Post-installation handover pack** including all of the above, dated and signed off
...
For comparison data with other materials, see [steel vs timber entrance doors](/blog/steel-vs-timber-entrance-doors).
...
Start with a [free site survey](/contact) for any door programme on a building within Building Safety Act scope. Coverage is nationwide UK mainland. The [security specification page](/security-specification) sets out the certifications side by side. The [HMO landlord guide](/blog/hmo-front-door-requirements-uk-landlord-guide) covers the parallel HMO regime in detail.`,
};
