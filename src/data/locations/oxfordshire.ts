...
export const oxfordshireLocations: Location[] = [
  ...
  },
  {
    ...
    tier: 3,
    description:
      "Chipping Norton in OX7, affectionately known as Chippy, is perched high on the Cotswold escarpment and is the unofficial capital of the Oxfordshire Cotswolds within the Cotswolds AONB. The Market Place conservation area is ringed by Grade II listed Georgian coaching inns, townhouses and the Grade I listed Church of St Mary the Virgin. The Chipping Norton Set (David Cameron, Jeremy Clarkson, Rebekah Brooks and others) has famously associated the area with high-profile residency. Residential streets including New Street, West Street, Horsefair and Albion Street carry listed stone cottages and Georgian townhouses, while the surrounding villages of Great Tew (privately owned model village), Kingham, Churchill, Sarsden and the Wychwoods add substantial stone farmhouses, converted wool barns and country estates on plots of two to twenty acres. SteelR bespoke steel entrance doors suit this discerning market with hand-finished ironmongery in antique brass, heritage colour palettes matching the Cotswold limestone, marine-grade powder coat for the exposed hilltop weather, and LPS 1175 SR4 D10 Issue 8 Commercial-grade upgrade (with LPS 1673 Ultra-high also available by enquiry) specified on roughly one in four Cotswolds projects. OX7 surveyed from our Ickenham workshop.",
    localFeatures: [
