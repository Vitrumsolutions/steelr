...
export const otherCitiesLocations: Location[] = [
  ...
  },
  {
    ...
    tier: 2,
    description:
      "Cardiff blends castle-centred civic grandeur with the Victorian splendour of Cathays Park and the leafy prosperity of Pontcanna, Cyncoed and Lisvane. The CF11 postcode covering Pontcanna and Cathedral Road contains some of Wales' most prestigious Edwardian bay-fronted terraces, with Plasturton Avenue, Kings Road and Llandaff Fields Road commanding premium prices. Cyncoed and Lisvane in CF23 and CF14 offer substantial detached family homes along Rhydypenau Road and Mill Road, while Victorian bay-fronted houses line Roath Park and Penylan in CF24 under strict conservation controls. Cardiff Bay's contemporary waterfront developments across CF10 and CF11 favour bolder door specifications. SteelR provides bespoke steel entrance doors for Cardiff homeowners seeking a statement piece that withstands the Welsh climate, with 70mm thermally broken leaves achieving U-values from 0.9 W/m2K. Finishes include RAL 6009 Fir Green, RAL 9005 Jet Black and RAL 5008 Grey Blue with brass, chrome or bronze ironmongery. Every SteelR door is PAS 24:2022 certified, BS EN 1627:2011 RC4 single leaf, unglazed certified as Standard, Secured by Design approved, FD30S fire and smoke rated, with LPS 1175 SR3 (Enhanced upgrade), LPS 1175 SR4 D10 Issue 8 (Commercial-grade upgrade) and LPS 1673 attack-resistance (Ultra-high, by enquiry) available on every door.",
    localFeatures: [
