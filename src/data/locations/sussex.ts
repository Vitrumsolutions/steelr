...
export const sussexLocations: Location[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Around eight weeks from first enquiry to finished installed door. Around six of those weeks are manufacturing in our UK facility. One to two weeks are the survey and design process. Installation itself is typically a single day for a single-leaf door and two days for a double-door or sidelight configuration. There is no regional surcharge for Sussex postcodes and the install team are SteelR employees, DBS-checked and directly employed.",
      },
      {
        question:
