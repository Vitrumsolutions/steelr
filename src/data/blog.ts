...
export const posts: BlogPost[] = [
  {
    ...
    imageAlt:
      "Black contemporary steel entrance door with dual sidelights — example of bespoke steel door design",
    content: `## Why Your Front Door Material Matters
...
Every SteelR entrance door achieves SR3 as standard — not as an upgrade or optional extra. Combined with ISO 9001 certified manufacturing, fire-rated steel construction and [Secured by Design approval](/blog/secured-by-design-doors), SteelR doors provide the highest level of security available for a residential entrance door in the United Kingdom. See examples of our [traditional steel doors with lion knockers](/collection/black-traditional-lion-knocker-open) and [contemporary designs](/collection/black-contemporary-dual-sidelights) in our collection.`,
  },
  {
    ...
    readTime: "4 min read",
    category: "Design",
    image: "/images/gallery/steelr-red-traditional-lion-knocker.jpg",
    imageAlt: "Red traditional steel door with lion knocker — bold colour choice",
    content: `## Your Front Door Sets the Tone
...
Black remains the most popular choice for entrance doors in the UK. It works with virtually every architectural style — from Georgian townhouses to contemporary new builds. Black conveys elegance, authority and timelessness.

### Navy Blue (RAL 5011 / RAL 5004)
Navy has emerged as one of the most sought-after door colours in recent years. It offers the sophistication of black with added warmth and character. Navy works particularly well with brass hardware and stone or brick surrounds.

### Sage Green (RAL 6021 / RAL 7033)
Sage and muted green tones have surged in popularity, especially for period properties and homes with natural landscaping. Green creates a welcoming, organic feel and pairs beautifully with both chrome and brass hardware.
...
- **Georgian/Victorian:** Black, navy, dark green or heritage colours
- **Edwardian:** Deep reds, olive, forest green
- **Contemporary:** Anthracite grey, charcoal, bold accent colours
- **Country/Rural:** Sage, olive, cream, muted natural tones
...
At SteelR, colour is just the beginning. Every door is manufactured to your exact specification with your choice of colour, hardware, glazing, panel design and decorative elements. See our [red traditional door with lion knocker](/collection/red-traditional-lion-knocker), [navy panelled door](/collection/navy-panelled-chrome-palms), or [sage contemporary design](/collection/sage-contemporary-bar-handle-sidelight) for inspiration. [Contact us](/contact) to discuss your vision.`,
  },
  {
    ...
    imageAlt:
      "Black steel entrance door with ring knocker in a recessed porch — Secured by Design accredited",
    content: `## What Is Secured by Design?
...
If you are looking for Secured by Design doors that combine the highest security standards with complete design freedom, we would welcome the opportunity to discuss your project. Contact SteelR to start your bespoke door consultation.`,
  },
  {
    ...
    readTime: "7 min read",
    category: "Buying Guide",
    image: "/images/gallery/steelr-cream-panelled-chrome-sidelight.jpg",
    imageAlt:
      "Cream panelled steel entrance door with chrome hardware and sidelight — bespoke steel door installation",
...
1. Conduct an initial discussion to understand your requirements
2. Arrange a professional site survey to take precise measurements
...
At SteelR, we provide transparent, fully itemised quotations for every project. Every door is SR3 rated, Secured by Design accredited and manufactured under ISO 9001 as standard — not as costly upgrades. Contact us to discuss your project and receive a no-obligation consultation.`,
  },
  {
    ...
    content: `## Why Architects Are Specifying Steel Entrance Doors
...
1. **Technical datasheets** — U-values, security ratings, fire ratings, acoustic performance, air permeability, water tightness and wind resistance
2. **CAD details** — plan, section and elevation drawings for integration into project documentation
3. **NBS specifications** — clauses formatted for direct inclusion in project specifications
4. **Sample materials** — RAL colour samples, hardware samples and material swatches
5. **Site survey** — professional measurement and assessment of the installation conditions
6. **Test certificates** — independent laboratory reports for all claimed performance criteria
